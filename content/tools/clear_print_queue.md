---
title: clear_print_queue
name: clear_print_queue
description: "Cancels all pending and stuck print jobs. Use when the print queue is jammed and jobs cannot be removed through normal means."
metadata:
  maxAggregateRisk: medium
  affectedScope: ["system"]
requiresConsent: true
sourceUrl: https://github.com/idemeum/skills/blob/main/clearPrintQueue.ts
---
