---
title: get_cpu_temperature
name: get_cpu_temperature
description: "Reports CPU temperature and checks for thermal throttling. High temperatures (>90°C) indicate cooling issues that degrade performance. macOS uses powermetrics; Windows uses WMI."
metadata:
  maxAggregateRisk: low
  affectedScope: ["user"]
requiresConsent: false
sourceUrl: https://github.com/idemeum/skills/blob/main/getCpuTemperature.ts
---
