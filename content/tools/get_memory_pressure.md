---
title: get_memory_pressure
name: get_memory_pressure
description: "Reports current memory pressure level, RAM usage breakdown, and swap usage. Use when diagnosing system slowness caused by memory exhaustion."
metadata:
  maxAggregateRisk: low
  affectedScope: ["user"]
requiresConsent: false
sourceUrl: https://github.com/idemeum/skills/blob/main/getMemoryPressure.ts
---
