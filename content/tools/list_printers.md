...
title: list_printers
name: list_printers
description: "Lists all configured printers with their status, type (local/network), and current queue depth. Use at the start of any printer troubleshooting workflow."
metadata:
  maxAggregateRisk: low
  affectedScope: ["user"]
requiresConsent: false
sourceUrl: https://github.com/idemeum/skills/blob/main/listPrinters.ts
---
