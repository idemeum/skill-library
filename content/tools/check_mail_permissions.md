---
title: check_mail_permissions
name: check_mail_permissions
description: "Checks file system permissions on the Mail data directory. Incorrect permissions cause Mail sync failures and index corruption. macOS only."
metadata:
  maxAggregateRisk: low
  affectedScope: ["user"]
requiresConsent: false
sourceUrl: https://github.com/idemeum/skills/blob/main/checkMailPermissions.ts
---
