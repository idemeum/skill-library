---
title: sync_system_time
name: sync_system_time
description: "Forces an immediate NTP clock resync on the endpoint. Use ONLY after check_ntp_status reports significant drift. Requires admin privileges. Large time jumps can break in-flight TLS sessions and trigger endpoint security software alerts — always run dry-run first so the user can see the command."
metadata:
  maxAggregateRisk: medium
  affectedScope: ["system"]
requiresConsent: true
sourceUrl: https://github.com/idemeum/skills/blob/main/syncSystemTime.ts
---
