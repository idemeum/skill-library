---
title: clear_xcode_derived_data
name: clear_xcode_derived_data
description: "Clears Xcode's DerivedData folder containing build artifacts that commonly grow to 10-30GB. Optionally clears Xcode Archives and device support files. macOS only."
metadata:
  maxAggregateRisk: medium
  affectedScope: ["user"]
requiresConsent: false
sourceUrl: https://github.com/idemeum/skills/blob/main/clearXcodeDerivedData.ts
---
