...
title: reconnect_vpn
name: reconnect_vpn
description: "Disconnects and reconnects a VPN profile by name. Use when a VPN connection is stale, showing connected but not routing traffic, or after network changes."
metadata:
  maxAggregateRisk: medium
  affectedScope: ["network", "system"]
requiresConsent: false
sourceUrl: https://github.com/idemeum/skills/blob/main/reconnectVpn.ts
---
