---
title: check_firewall_status
name: check_firewall_status
description: "Reports the current state of the operating system firewall. Use during security compliance checks, network troubleshooting, or when verifying security agent health."
metadata:
  maxAggregateRisk: low
  affectedScope: ["user"]
requiresConsent: false
sourceUrl: https://github.com/idemeum/skills/blob/main/checkFirewallStatus.ts
---
